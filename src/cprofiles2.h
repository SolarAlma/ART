...
class cprofiles{
 ...
 cprofiles():mki(NULL), mkq(NULL), mku(NULL), mkv(NULL), mfq(NULL), mfu(NULL), mfv(NULL){};
  ...
  */
  ...
  // Constructor
  //----------------------------------------------------------------
 cprofiles(int nw, int ndep):mki(NULL), mkq(NULL), mku(NULL), mkv(NULL), mfq(NULL), mfu(NULL), mfv(NULL){
    nnw = 0;
    nndep = 0;
    init(nw, ndep);
  }
